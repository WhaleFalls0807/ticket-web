      ...
      <el-collapse>
        <el-collapse-item v-for="(item, index) in dataForm.businessTypeList" :key="index" :title="item.businessType">
          ...
          >
            ...
            <FileImgPreview v-else fileType="img" :url="item.logo" delete @deleteFileImg="item.logo = ''" />
          </el-form-item>
          <el-form-item
            label="身份证"
          ...
          >
            ...
            <FileImgPreview v-else fileType="file" :url="item.idcard" delete @deleteFileImg="item.idcard = ''" />
          </el-form-item>
          <el-form-item
            label="申请书"
          ...
          >
            ...
            <FileImgPreview v-else fileType="file" :url="item.applyBook" delete @deleteFileImg="item.applyBook = ''" />
          </el-form-item>
          <el-form-item
            label="委托书"
